...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/img/LogoGaharu.png') }}">
    <link rel="icon" type="image/png" href="{{ asset('assets/img/LogoGaharu.png') }}">
    <title>@yield('title', 'Mapala Gaharu')</title>
...
<body class="about-us bg-gray-100">
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-8 ps-lg-5" id="navigation">
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                    ...
                    <li class="nav-item my-auto ms-3 ms-lg-0">
                        <a href="{{ route('login') }}" class="btn btn-sm  bg-white  mb-0 me-1 mt-2 mt-md-0">Masuk</a>
                    </li>
    ...
    {{-- Footer (Akan ada di setiap halaman) --}}
